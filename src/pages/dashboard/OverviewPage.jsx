...
export default function OverviewPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto">
      ...
      <div className={`rounded-xl sm:rounded-2xl p-4 sm:p-5 mb-4 sm:mb-6 border-2 ${isConnected ? "border-green-200 bg-green-50" : "border-pink-200 bg-pink-50"}`}>
        ...
        {!isConnected && (
          ...
          >
            ...
            <span className="hidden sm:inline">Connect Instagram Business Account</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
        ...
        >
          ...
          <p className="font-bold text-sm sm:text-base text-gray-900">Setup Automation</p>
        ...
        >
          ...
          <p className="font-bold text-sm sm:text-base text-gray-900">Analytics</p>
          <p className="text-xs text-gray-500 mt-1">
      ...
      {stats && (
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          {[
            ...
            <div key={label} className="bg-white rounded-lg sm:rounded-xl border border-gray-100 p-3 sm:p-4 text-center">
