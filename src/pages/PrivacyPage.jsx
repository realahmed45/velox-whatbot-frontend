    ...
    <div className="min-h-screen bg-ink-50 py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-8">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            <h2 className="text-2xl font-bold text-ink-900 mb-3">Introduction</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-ink-900 mb-3">Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-ink-900 mb-3">How We Use Your Information</h2>
            <p className="text-ink-600 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-bold text-ink-900 mb-3">Data Security</h2>
            <p className="text-ink-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-ink-900 mb-3">Data Retention</h2>
            <p className="text-ink-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-ink-900 mb-3">Your Rights</h2>
            <p className="text-ink-600 leading-relaxed">
