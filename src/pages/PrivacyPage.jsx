        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              Botlify ("we", "our", "us") operates the Botlify platform. This
              Privacy Policy explains how we collect, use, disclose, and
              safeguard your information when you use our Service for Instagram
              DM automation.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-ink-600 leading-relaxed mb-3">
              When you connect your Instagram Business account via Instagram's
              OAuth, we collect:
            </p>
          ...
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              ...
              data. All access tokens are encrypted at rest. We never share,
              sell, or distribute your data to third parties except as required
              by law.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              ...
              you disconnect your Instagram account or delete your Botlify
              workspace, we permanently delete all associated data within 30
              days.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              ...
              disconnect your Instagram account to revoke our access
              immediately.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-ink-900 mb-3">Contact Us</h2>
            <p className="text-ink-600 leading-relaxed">
