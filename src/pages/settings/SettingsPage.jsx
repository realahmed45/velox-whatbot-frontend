...
// Holiday / manual-away mode. A big master switch: when ON, every incoming
// message gets one calm "a manager will get back to you" reply and the AI +
// all other automations are paused. Saves via PUT /workspaces/:id (holidayMode).
function HolidayModeCard({ workspace, onSave }) {
  const { activeWorkspace } = useAuthStore();
  const DEFAULT_MSG =
