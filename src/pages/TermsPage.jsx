        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              By accessing or using Botlify, you agree to be bound by these
          ...
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              Botlify provides Instagram DM automation services that allow you
              to send automated greeting and follow-up messages to your
              Instagram followers. The Service integrates with Instagram's
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-ink-600 space-y-2 ml-4">
              ...
              <li>
                Comply with Instagram's Terms of Service and Community
                Guidelines
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              You must have an Instagram Business or Creator account to use
              Botlify. Professional accounts (Business/Creator) are required to
              access Instagram's messaging API.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              Botlify is provided "as is" without warranties of any kind. We are
              not liable for any damages arising from your use of the Service,
              including but not limited to Instagram account restrictions, data
          ...
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              ...
              violate these Terms or engage in fraudulent or harmful activities.
              You may terminate your account at any time by disconnecting your
              Instagram account and deleting your workspace.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-ink-600 leading-relaxed">
              ...
              <a
                href="mailto:support@botlify.com"
